<?php
	...
	class Mage_Idealcheckoutclickandbuy_Model_Idealcheckoutclickandbuy extends Mage_Payment_Model_Method_Abstract
	{
		...
		// This url is called after order confirmation; It triggers IdealcheckoutclickandbuyController->redirectAction()
		public function getOrderPlaceRedirectUrl() 
		{
			$sUrl = Mage::getUrl('idealcheckoutclickandbuy/idealcheckoutclickandbuy/redirect', array('_secure' => true));
			return $this->fixUrl($sUrl, false);
		}
	


		// Setup idealcheckoutclickandbuy transaction record in database - called in: IdealcheckoutclickandbuyController->redirectAction()
		public function setupPayment()
		{
			...
			{
				// Mage::throwException(Mage::helper('idealcheckoutclickandbuy')->__('The total amount of order #' . $iOrderId . ' is ' . $this->_order->getGrandTotal() . ', but should be at least 1.00.'));
			}
			...
			$sReturnUrl = Mage::getUrl('idealcheckoutclickandbuy/idealcheckoutclickandbuy/return', array('_secure' => true, 'order_id' => $sOrderId, 'order_code' => $sOrderCode));
...
`transaction_log` = NULL;";
		...
		// Validate payment after user returns from Click and Buy - called in: IdealcheckoutclickandbuyController->returnAction()
