<?php
	...
	class Mage_Idealcheckoutideal_Model_Idealcheckoutideal extends Mage_Payment_Model_Method_Abstract
	{
		...
		// This url is called after order confirmation; It triggers IdealcheckoutidealController->redirectAction()
		public function getOrderPlaceRedirectUrl() 
		{
			$sUrl = Mage::getUrl('idealcheckoutideal/idealcheckoutideal/redirect', array('_secure' => true));
...
`transaction_log` = NULL;";
		...
		public function validatePayment($sOrderId, $sOrderCode)
		{
			...
			if(isset($aRecord['transaction_status'])) // if(sizeof($oRecordset))
			{
				...
				{
idealcheckout_log($sState, __FILE__, __LINE__);
idealcheckout_log($sTransactionStatus, __FILE__, __LINE__);
					if(in_array($sTransactionStatus, array('SUCCESS')))
					{
