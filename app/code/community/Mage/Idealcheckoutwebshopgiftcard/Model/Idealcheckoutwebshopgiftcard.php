<?php
	...
	class Mage_Idealcheckoutwebshopgiftcard_Model_Idealcheckoutwebshopgiftcard extends Mage_Payment_Model_Method_Abstract
	{
		...
		// This url is called after order confirmation; It triggers IdealcheckoutwebshopgiftcardController->redirectAction()
		public function getOrderPlaceRedirectUrl() 
		{
			$sUrl = Mage::getUrl('idealcheckoutwebshopgiftcard/idealcheckoutwebshopgiftcard/redirect', array('_secure' => true));
			return $this->fixUrl($sUrl, false);
		}
	


		// Setup idealcheckoutwebshopgiftcard transaction record in database - called in: IdealcheckoutwebshopgiftcardController->redirectAction()
		public function setupPayment()
		{
			...
			{
				// Mage::throwException(Mage::helper('idealcheckoutwebshopgiftcard')->__('The total amount of order #' . $iOrderId . ' is ' . $this->_order->getGrandTotal() . ', but should be at least 1.00.'));
			}
			...
			$sReturnUrl = Mage::getUrl('idealcheckoutwebshopgiftcard/idealcheckoutwebshopgiftcard/return', array('_secure' => true, 'order_id' => $sOrderId, 'order_code' => $sOrderCode));
...
`transaction_log` = NULL;";
		...
		// Validate payment after user returns from Webshop Giftcard - called in: IdealcheckoutwebshopgiftcardController->returnAction()
