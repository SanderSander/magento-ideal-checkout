...
`transaction_log` = NULL;";
			...
			// Return Handmatig overboeken URL
		...
		// Validate payment after user returns from Handmatig overboeken - called in: IdealcheckoutmanualtransferController->returnAction()
